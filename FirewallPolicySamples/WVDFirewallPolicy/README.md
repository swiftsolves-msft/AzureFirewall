...
![New app](https://github.com/swiftsolves-msft/blob/master/AzureFirewall/FirewallPolicySamples/WVDFirewallPolicy/images/urls.png?raw=true)

Use the following format for the Array data for AD_DNSServers

```["xx.xx.xx.xx","yy.yy.yy.yy"]```

![New app](https://github.com/swiftsolves-msft/blob/master/AzureFirewall/FirewallPolicySamples/WVDFirewallPolicy/images/addnspic.png?raw=true)
